...
def filtrar_novos(
    artigos: list[Artigo], ja_vistos: set[str], publicados: set[str]
) -> list[Artigo]:
    """Remove duplicados (ledger + publicados) e artigos claramente negativos,
    devolvendo os candidatos ordenados do mais positivo para o menos."""
    novos: list[Artigo] = []
